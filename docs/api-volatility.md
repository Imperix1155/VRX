...
| **CVR `instanceSettingPrivacy`** | Instance access level (public, friends, invite, etc.) | 🟡 6 values verified, 4 missing from live capture | Unknown value → unknown privacy (non-critical for display) |
