...
| --- | --- | --- | --- | --- |
| `get-friends` | `{ platform }` | `Friend[]` | `ipc/friends.ts` | Delegates to the adapter; throws when nothing fetched AND pages/records failed |
| `get-accounts` | — | `Account[]` | `ipc/accounts.ts` | Stub `[]` until VRX-24 |
