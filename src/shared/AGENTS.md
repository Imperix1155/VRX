...
- `joinability.ts` — pure `isFriendJoinable(friend)` predicate shared by main now and renderer later: requires in-game + visible non-sentinel instance and rejects CVR offline instances (VRX-166).
