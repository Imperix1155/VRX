...
- [`services/adapters/vrchat/AGENTS.md`](services/adapters/vrchat/AGENTS.md) — VRChat parsers/builders plus the friend fetcher & world resolver: presence, instance-type, trust-rank, join-URL (VRX-44/45/49/50), `fetchFriends` (VRX-43), `WorldResolver` (VRX-46).
