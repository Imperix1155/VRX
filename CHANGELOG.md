...
- **Unknown ChilloutVR privacy is no longer mislabeled private.** If CVR sends a privacy value VRX does not recognize, the join confirmation now says "Openness unknown — treat it as public." while the underlying parser still degrades safely and never crashes. Recognized Invite instances keep their existing effectively-private wording. (VRX-240)
